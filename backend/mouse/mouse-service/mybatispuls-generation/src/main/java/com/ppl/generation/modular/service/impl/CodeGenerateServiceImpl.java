...
package com.ppl.generation.modular.service.impl;
...
import th.lmoc.generate.core.tool.StringDateTool;
import th.lmoc.generate.core.util.Util;
import th.lmoc.generate.modular.entity.CodeGenerate;
import th.lmoc.generate.modular.entity.SysCodeGenerateConfig;
import th.lmoc.generate.modular.enums.CodeGenerateExceptionEnum;
import th.lmoc.generate.modular.mapper.CodeGenerateMapper;
...
import th.lmoc.generate.modular.service.CodeGenerateService;
...
public class CodeGenerateServiceImpl extends ServiceImpl<CodeGenerateMapper, CodeGenerate> implements CodeGenerateService {
    ...
    public PageResult<CodeGenerate> page(CodeGenerateParam codeGenerateParam) {
        ...
        queryWrapper.lambda().orderByDesc(CodeGenerate::getCreateTime);
